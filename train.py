...
def parse_args():
    ...
    parser.add_argument('--num_attn_layer', default=2, type=int)
    ...
    parser.add_argument('--no_encoder_annealling', default=False, action='store_true')
    ...
    parser.add_argument('--no_project', default=False, action='store_true')
    ...
    update_args(args)
    args.encoder_annealling = not args.no_encoder_annealling
    return args
